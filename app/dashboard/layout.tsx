    ...
    return (
      <div className="flex">
        ...
        <div className="flex flex-col p-4 border-r border-gray-300 h-screen gap-2">
            ...
            <Link href="/user" className="bg-gray-900 text-white p-4 hover:bg-gray-500 w-64 flex items-center justify-center rounded-md hover:shadow-md">User dashboard</Link>
        </div>
